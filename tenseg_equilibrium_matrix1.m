...
%   l_gp: members' length vector in group4
%	as variable.
%%
% element length

 H= N*C';  
 l = sqrt(diag(H' * H));   % Compute member lengths
 l(19:end) = 0.95 * l(19:end); %YJYJYJYJYJYJ 95% string length% element's direction matrix       
